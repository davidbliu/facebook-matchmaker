...
def get_newsfeed_list():
	...
	# pbl_group_posts = graph.get_object("662368253870683/feed?limit=25&until=1414709581&__paging_token=enc_Aez6xQ9zQwaELTEoorStyL_fDUDU2szio11zbF4Kev3nnKGuTfncf-npA8Wuyx2iwTXEFd4COTf61hbnl8Za2RlWFyC2Up1SdgrYymXt-G_quA")
	# with open('testing.json', 'w') as f:
	# 	f.write(pbl_group_posts)
